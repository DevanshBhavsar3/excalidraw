  ...
  return (
    <section className="z-10 flex flex-col items-center text-center relative overflow-hidden">
      ...
      <div className="z-10 py-44 flex flex-col items-center text-center">
        ...
        <Link
          href={"/signup"}
          className="border-2 border-primary text-black hover:bg-primary-dark hover:text-white px-4 py-1 rounded-full text-sm transition-all flex justify-center items-center gap-1"
        >
          Sign Up
